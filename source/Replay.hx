...
class Replay
{
	...
	public function SaveReplay(notearray:Array<Dynamic>, judge:Array<String>, ana:Analysis)
	{
		...
		path = Main.path + "replay-" + PlayState.SONG.song + "-time" + time + ".kadeReplay"; // for score screen shit
	...
	public function LoadFromJSON()
	{
		...
		try
		{
			var repl:ReplayJSON = cast Json.parse(openfl.utils.Assets.getText("assets/replays/" + path));
			replay = repl;
		}
		catch(e)
		{
