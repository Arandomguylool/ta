...
class OutdatedSubState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var txt:FlxText = new FlxText(0, 0, FlxG.width,
			"This mod isn't made by me!"
			+ "\nThis mod was made by the Accelerant Hank team"
			+ "\n\nYou can go to the gamebanana page by clicking SPACE\n\n"
			+ "\n or press ESCAPE to ginore this!",
			32);
	...
	override function update(elapsed:Float)
	{
		if (controls.ACCEPT)
		{
			fancyOpenURL("https://gamebanana.com/mods/286594");
		}
		if (controls.BACK)
		{
			leftState = true;
